...
export default function Contact() {
  const { name, email, github, linkedin, location } = portfolioData;
        ...
        <div className="space-y-6">
          <div className="bg-slate-900/50 rounded-xl p-6 border border-slate-800">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <a href={`mailto:${email}`} className="text-white hover:text-blue-400 transition-colors">
                  {email}
                </a>
              </div>
            </div>
          ...
          <div className="flex gap-4">
            <a 
              ...
              className="flex-1 flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-700 text-white py-3 rounded-lg transition-colors"
            >
              <GithubIcon />
              GitHub
            </a>
